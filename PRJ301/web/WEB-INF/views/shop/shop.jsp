                    ...
                    <div class="card-body">
                        <form action="<c:url value="/shop/edit_handler.do" />">
                            ...
                            <div class="mt-3 d-flex justify-content-between">    
                                ...
                                <div style="display: none" class="sure-prompt" id = ${product.proID}>
                                    <h3>Are you sure?</h3>
                                    <button type="submit" class="btn btn-success" name="op" value="delete">Yes</button>
                                    <button class="btn btn-danger" name="op" value="back" onclick="{
                                            ...
                                            <button onclick="{
                                            var sure = document.getElementById(${product.proID});
                                            sure.style.display = 'block';
                                        }" class="btn btn-outline-danger"><i class="bi bi-x-lg"></i> Delete</button></br>
                    </div>
                </div>
            </div>
        </c:forEach>
